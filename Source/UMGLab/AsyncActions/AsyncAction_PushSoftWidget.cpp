...
UAsyncAction_PushSoftWidget* UAsyncAction_PushSoftWidget::PushSoftWidget(const UObject* WorldContextObject, APlayerController* OwningPlayerController, TSoftClassPtr<ULabActivatableWidgetBase> InSoftWidgetClass, UPARAM(meta = (Categories = "Lab.WidgetStack")) FGameplayTag InWidgetStackTag, bool bFocusOnNewlyPushedWidget)
{
...
{
	ULabUIGameInstanceSubsystem& UISubsystem = ULabUIGameInstanceSubsystem::Get(CachedOwningWorld.Get());

	UISubsystem.PushSoftWidgetToStackAsync(CachedWidgetStackTag, CachedSoftWidgetClass,
		[this](EAsyncPushWidgetState InPushState, ULabActivatableWidgetBase* PushedWidget)
		{
			switch (InPushState)
			{
